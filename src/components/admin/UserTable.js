...
export default function UserTable(props) {
  ...
  const userArray = changeUserState.userArray.map((element) => element.doc);
  ...
  useEffect(() => {
    const user_array = changeUserState.userArray.map((element) => element.doc);
    setState((prevState) => ({ ...prevState, data: user_array }));
  }, [changeUserState.userArray]);
